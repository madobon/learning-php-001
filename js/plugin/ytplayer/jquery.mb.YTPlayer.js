...
// END DEL madobon
		...
		changeMovie: function (opt) {
			...
			// STR CHG madobon
			// if (YTPlayer.opt.addRaster) {
			if (YTPlayer.opt.addRaster && jQuery(YTPlayer.playerEl).is(':visible')) {
			// END CHG madobon
				var retina = (window.retina || window.devicePixelRatio > 1);
...
// END ADD madobon
		...
		manageYTPProgress: function () {
			...
			var totalTime = YTPlayer.videoData.duration;
			// END CHG madobon
		...
		checkForState:function(YTPlayer){
			...
			YTPlayer.getState = setInterval(function () {
				...
				if ((YTPlayer.videoData.duration < YTPlayer.player.getCurrentTime()) && YTPlayer.player.getPlayerState() == 1) {
				// END CHG madobon					
	...
	jQuery.fn.optimizeDisplay = function () {
		...
		var el = !YTPlayer.isBackground ? jQuery(this) : jQuery(window);
		// END CHG madobon
